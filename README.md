...
Built with Next.js, Vaultive is a financial SaaS platform that connects to multiple bank accounts, displays transactions in real-time, allows users to transfer money to other platform users, and manages their finances altogether. 
...
export const createLinkToken = async (user: User) => {
  try {
    ...
    console.error(
      "An error occurred while creating a new Vaultive user:",
      error
    );
  }
};
